"""
Django settings for myapp100_1 project.
...
WSGI_APPLICATION = 'myapp100_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "myapp100_1 API",
    "DESCRIPTION": "API documentation for myapp100_1 App",
    "VERSION": "v1",
}
